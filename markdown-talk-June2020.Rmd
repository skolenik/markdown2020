...
need_packages <- c("here", "knitr", "kableExtra", "flextable", "tidyverse",
                   "xaringanthemer", "shiny", "countdown")
...
Here's the defining quote by Donald Knuth, who was basically one of the founders
of theoretical computer science. His multivolume book "The Art of Computer Programming"
is a fundamental reading. He also authored TeX program for mathematical typesetting
in 1970s which is the defacto publishing standard these days. TeX was an early example
of the literate programming ideas.
...
So... avoid copy-paste if you can. I try to, as hard as I can.
...
The ideas and methods of markdown are used in many modern data science-y products.
While I advertised this webinar as the art of reproducible report generation,
I can also state that books are written in markdown; dashboards are created in markdown;
and this very presentation was prepared in markdown.
...
So I've been saying a lot how great it is that you can incorporate
statistical output in markdown. How exactly does that happen? What you type
is the narrative text and the code; but the code needs to be run.
What is the magic that puts the numbers into the output? 
We can call this step "compilation", or "rendering". In RStudio, it is 
the "Knit" button.
...
such as `title`, `author`, `date`, `output`, and suboptions for 
